      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-gray-300 dark:text-gray-400">
              Temukan akomodasi sempurna untuk liburan impian Anda di Pantai Sawarna, dari villa mewah hingga homestay yang nyaman.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-white dark:text-gray-100">Tautan Cepat</h4>
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Beranda</Link>
              </li>
              <li>
                <Link to="/villas" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Villa</Link>
              </li>
              <li>
                <Link to="/penginapan-sawarna" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Penginapan</Link>
              </li>
              <li>
                <Link to="/articles" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Artikel</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Tentang Kami</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Kontak</Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-300 hover:text-ocean dark:text-gray-400 dark:hover:text-ocean-light transition-colors">Syarat & Ketentuan</Link>
              </li>
            </ul>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-white dark:text-gray-100">Hubungi Kami</h4>
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin size={18} className="mr-2 mt-1 flex-shrink-0 text-ocean dark:text-ocean-light" />
                <span className="text-gray-300 dark:text-gray-400">Jl. Pantai Sawarna, Desa Sawarna, Kecamatan Bayah, Kabupaten Lebak, Banten, Indonesia</span>
              </li>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-white dark:text-gray-100">Berlangganan</h4>
            <p className="text-gray-300 dark:text-gray-400 mb-4">
              Berlangganan newsletter kami untuk mendapatkan penawaran spesial.
            </p>
            <form>
              <div className="flex">
                <input
        ...
        <div className="border-t border-gray-800 dark:border-gray-800 mt-12 pt-6 text-center">
          <p className="text-gray-400 dark:text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} VillaSawarna. Hak cipta dilindungi.
          </p>
        </div>
      </div>
    </footer>
