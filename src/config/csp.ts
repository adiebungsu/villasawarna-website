...
const productionCSP = `
  ...
  img-src 'self' https://villasawarna.com * data: blob: https: https://i.imgur.com https://imgur.com;
  script-src 'self' https://accounts.google.com https://villasawarna.com https://*.googleapis.com https://*.gstatic.com;
  style-src 'self' https://fonts.googleapis.com https://villasawarna.com https://*.googleapis.com https://unpkg.com https://accounts.google.com;
  font-src 'self' https://fonts.gstatic.com data:;
  connect-src 'self' https://accounts.google.com https://villasawarna.com https://*.googleapis.com https://*.firebasestorage.googleapis.com https://api.villasawarna.com https://*.firebaseio.com;
  media-src 'self' blob: https://*.firebasestorage.googleapis.com;
  object-src 'none';
  frame-src 'self' https://accounts.google.com;
`;
