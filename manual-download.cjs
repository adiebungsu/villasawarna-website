...
// Data villa yang sudah diketahui memiliki room types (dari properties.ts)
const villaRoomData = [
  {
  ...
  {
    villaId: "villa-deka-sawarna",
    rooms: [
      {
        id: "standard-room",
        images: [
          "https://i.imgur.com/398KB.jpeg",
          "https://i.imgur.com/273KB.jpeg",
          "https://i.imgur.com/45KB.jpeg",
          "https://i.imgur.com/71KB.jpeg",
          "https://i.imgur.com/321KB.jpeg"
        ]
      }
    ]
  }
...
async function downloadRoomTypeImages() {
  try {
    console.log('🚀 Starting manual room type images download...\n');
